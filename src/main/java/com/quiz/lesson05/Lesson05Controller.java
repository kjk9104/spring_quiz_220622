...
public class Lesson05Controller {
	...
	// http://localhost/lesson05/quiz02/1
	@RequestMapping("/quiz02/1")
	public String ex02_1(Model model) {
		...
		return "/lesson05/quiz02-1View";
	}
	
	@RequestMapping("/quiz02/2")
	// http://localhost/lesson05/quiz02/2
	public String ex02_2(Model model) {
	...
	public String quiz03_1(Model model) {
		...
		return "/lesson05/quiz03_1View";
	}
	
	// http://localhost/lesson05/quiz04/1
	@RequestMapping("/quiz04/1")
	public String quiz04_1(Model model) {
